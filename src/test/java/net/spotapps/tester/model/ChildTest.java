...
public class ChildTest {
    ...
    public void testChildInequality(Child testChild1, Child testChild2) {
        ...
        if (testChild2 != null) {
            assertNotEquals(testChild2, testChild1, "Inequality should be symmetric");
        }
    }
    ...
    public void testChildEquality(Child testChild1, Child testChild2) {
        ...
        assertEquals(testChild2, testChild1, "Equality should be symmetric");
    }
    ...
    private static Stream<Arguments> provideDifferentChildren() {
        ...
        Child childNull2 = new Child();
        childNull2.setChildId(null);
        ...
        return Stream.of(
                ...
                Arguments.of(childNull, childNull2),
