...
public class OrientationTest {
    ...
    private static Stream<Arguments> provideDifferentOrientations() {
        ...
        Orientation orientationNullId = new Orientation("Straight");
        orientationNullId.setOrientationId(null);

        return Stream.of(
                Arguments.of(orientation1, orientation2),
                Arguments.of(orientation1, orientationNullId),
                Arguments.of(orientation1, null));
    }
    ...
    private static Stream<Arguments> provideIdenticalOrientations() {
        ...
        Orientation orientation2 = new Orientation("Straight");
